<%-- 
    Document   : listOrder
    Created on : Jun 17, 2024, 7:56:47 AM
    Author     : LENOVO
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            .popup {
                ...
                background-color: #DDD6C5; /* Màu nền của popup */
                color: #fff; /* Màu chữ của popup */
            ...
            .popup-overlay {
                ...
                width: 100%;
                height: 100%;
                background-color: rgba(0, 0, 0, 0.7); /* Màu nền overlay */
                z-index: 999;
            }
            .popup h2 {
                color: #282E52; 
    ...
    <body>
        <div id="body">
                    ...
                    <table>
                        ...
                        <c:forEach items="${result}" var="o">   
                            <tr>
                                <td>${o.orderID}</td>
                                <td>${o.emailServe}</td>
                                <td>${o.emailCashier}</td>
                                <td>${o.orderDate}</td>
                                <td>${o.phoneNumber}</td>
                                <td>${o.totalAmount}</td>
                                <td><button onclick="showOrderDetail('${o.orderID}')">View Details</button></td>
                            </tr>
                        </c:forEach> 
                    </table>
                </c:if>
            ...
            <div class="popup" id="order-detail-popup">
                <h2>Order Details</h2>
        ...
        <script>
            function showOrderDetail(orderID) {
                ...
                document.getElementById('order-detail-popup').style.display = 'block';

                var xhr = new XMLHttpRequest();
                xhr.open('GET', 'orderDetail?orderID=' + encodeURIComponent(orderID), true);
