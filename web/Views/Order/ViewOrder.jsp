...
<html>
    <head>
        ...
        <style>
            ...
            th {
                background-color: #ddd6c5; /* Màu nền của tiêu đề bảng */
                color: #282e52;
            }
            tr:nth-child(even) {
            ...
            .checkout-btn {
                background-color: #EE362B; /* Màu nền của nút checkout */
                color: #fff;
                border: none;
                padding: 10px 20px;
                border-radius: 5px;
            ...
            .checkout-btn:hover {
                background-color: #cc2a1e; /* Màu nền của nút khi di chuột qua */
            }
            ...
            <div class="container">
                ...
                <c:if test="${not empty showO}">
                    <table border="1">
                        ...
                        <c:forEach items="${showO}" var="detail">
                            <c:set var="itemName"/>
                            <c:set var="itemPrice" />
                            <tr>                           
                                <c:choose>
