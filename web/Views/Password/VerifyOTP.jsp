<%-- 
    Document   : verifyOTP
    Created on : Jun 5, 2024, 5:39:41 PM
    Author     : Thanh Cong
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="content">
                <h3>VERIFY OTP</h3>
                <form action="${pageContext.request.contextPath}/vOTP" method="post">
                    <label>OTP:</label><br/>
                    <div class="input-I">
                ...
                <c:if test="${not empty verifyError}">
                    <div id="myModal" class="modal" style="display: block;">
                        <div class="modal-content">
                            ...
                            <p>sss</p>
                            <p>${verifyError}</p>
                            <button onclick="redirectToLoginPage()">OK</button>
                        </div>
                    </div>
                </c:if>
        ...
        <script>
            ...
            function redirectToLoginPage() {
                window.location.href = "${pageContext.request.contextPath}/fPass";
            }
        </script>
    </body>
</html>
