...
<%@ page import="Model.TableViewModel" %>
...
<html lang="en">
    <head>
        ...
        <style>
            ...
            #header{
                ...
                align-items: center;
                align-self: stretch;
                border-bottom: 1px solid var(--neutral-600, #4C4D4E);
            }
            ...
            #tl{
                ...
                border-left: 1px solid var(--neutral-600, #4C4D4E);
            }

            #rb{
                border-radius:  0px 3px 3px 0px ;
                border-right: 1px solid var(--neutral-600, #4C4D4E);
            }
            ...
            th{
                ...
                background-color: #DDD6C5;
                color: #282e52;
                border-top: 1px solid var(--neutral-600, #4C4D4E);
                border-bottom: 1px solid var(--neutral-600, #4C4D4E);

            }

            th:first-child, td:first-child {
                border-left: none; /* Loại bỏ viền trái cho ô đầu tiên của mỗi hàng */
            }

            th:last-child, td:last-child {
                border-right: none; /* Loại bỏ viền phải cho ô cuối cùng của mỗi hàng */
            }
            td{
                padding-top: 10px;
                max-width: 130px;
                vertical-align: middle;
                border-left: 2px solid black; /* Đặt viền trái cho các ô trong bảng */
    ...
    <body>
            ...
            <div id="content">
                    <div id="header">
                        <form id="searchForm" action="/search" method="get">
                            <div id="search" style="display: flex; width: 332px; padding: 12px 16px; align-items: center; gap: 8px; border-radius: 12px; border: 1px solid var(--neutral-600, #ddd6c5); box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path d="M9.33846 17.6769C13.9437 17.6769 17.6769 13.9437 17.6769 9.33846C17.6769 4.73326 13.9437 1 9.33846 1C4.73326 1 1 4.73326 1 9.33846C1 13.9437 4.73326 17.6769 9.33846 17.6769Z" stroke="#ddd6c5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M19 19L16 16" stroke="#ddd6c5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                <input id="searchQuery" type="text" name="txtSearch" value="${txtS}" oninput="searchByAjax(this)" placeholder="Enter number..." style="border: none; outline: none; flex: 1;">
                            </div>
                        </form>

                        <form id="add" action="AddT" method="get">
                            <button type="submit" id="addFoodBtn">
                                ...
                                <path fill="#ddd6c5" fill-rule="evenodd" d="M12.75 8.744a.75.75 0 00-1.5 0v2.506H8.744a.75.75 0 000 1.5h2.506v2.506a.75.75 0 001.5 0V12.75h2.506a.75.75 0 000-1.5H12.75V8.744z" clip-rule="evenodd" style="animation:bounce 1s 1s infinite both;transform-origin:center center"/></svg>
                            </button>
                        </form>
                    </div>
                                ...
                                <table>
                                    <thead>
                                        <tr id="headerF">
                                            ...
                                            <th>ID</th>
                                            <th>Floor</th>
                                            <th class="column-table-number">Table Number</th>
                                            <th class="column-seating-capacity">Seating Capacity</th>
                                            <th>Status</th>
                                            <th id="rb">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody class="content">
                                        <c:choose>
                                            <c:when test="${empty requestScope.listTable}">
                                                <tr id="headerF">
                                                    <td colspan="7">No tables found.</td>
                                                </tr>
                                            </c:when>
                                            <c:otherwise>
                                                <c:forEach var="t" items="${requestScope.listTable}">
                                                    <tr id="infoF">
                                                        <td><img src="image/${t.tableImg}" alt="Table Image"></td>
                                                        <td>${t.tableID}</td>
                                                        <td>${t.floor}</td>
                                                        <td>${t.tableNumber}</td>
                                                        ...
                                                        <td>${t.status}</td>
                                                        <td>
                                                            <form action="Views/Table/UpdateTable.jsp" method="get" style="display:inline;">
                                                            ...
                                                            <form id="deleteTableForm" action="${pageContext.request.contextPath}/deleteTable" method="post" onsubmit="return confirmDelete(this, '${t.tableImg}', '${t.floor}', '${t.tableNumber}')">
                                                                <input type="hidden" name="tableID" value="${t.tableID}">
        ...
        <script>
                                                                function confirmDelete(form, imgSrc, floor, tableNumber) {
                                                                    event.preventDefault();

                                                                    Swal.fire({
                                                                        title: 'Are you sure you want to delete?',
                                                                        html: '<p>' + floor + ', ' + tableNumber + '</p>',
        ...
        <script>
            ...
            function showWarehouse() {
                window.location.href = '${pageContext.request.contextPath}/listPW';
            }

            function showImportList() {
                window.location.href = '${pageContext.request.contextPath}/listImport';
            }
