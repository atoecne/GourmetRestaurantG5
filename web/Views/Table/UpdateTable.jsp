...
<%
    ...
    TableModel table = tbd.getTableById(tableID);
%>
...
<html lang="en">
    ...
    <body>
        <div id="body">
            ...
            <div id="content">
                <form action="${pageContext.request.contextPath}/updateTable" method="post" enctype="multipart/form-data">
                    ...
                    <div id="bg">
                        <h1>UPDATE TABLE</h1>  
                        <div class="form-group" id="tblID">
                            <label for="tableID">Table ID:</label>
                            <input type="text" id="tableID" name="tableID" value="<%= table.getTableID()%>" readonly><br>
                        </div>
                        <div class="form-group">
                            <label for="floorSelect">Floor:</label>
                            <select name="floorid">
                                <option value="Fl0001" <%= (table.getFloorID().equals("Fl0001")) ? "selected" : ""%>>Floor 1</option>
                                <option value="Fl0002" <%= (table.getFloorID().equals("Fl0002")) ? "selected" : ""%>>Floor 2</option>
                                <option value="Fl0003" <%= (table.getFloorID().equals("Fl0003")) ? "selected" : ""%>>Floor 3</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="tableNumber">Table Number:</label>
                            <input type="text" id="tableNumber" name="tableNumber" placeholder="<%= table.getTableNumber()%>">
                        </div>
                        <div class="form-group">
                            <label for="seatingCapacity">Seating Capacity:</label>
                            <input type="number" id="seatingCapacity" name="seatingCapacity" placeholder="<%= table.getSeatingCapacity()%>">
                        </div>

                        <div class="form-group">
                            <label for="tableImg">Table Image:</label>
                            <input type="file" id="updateTableImg" name="tableImg">                
                        </div>
                        <br/>                        
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <div class="radio-container">
                                    <input type="radio" id="activeYes" name="Status" value="1" <% if (table.getStatus() == 1) { %> checked <% } %> >
                                    <label for="activeYes">Yes</label><br>
                                </div>
                                <div class="radio-container">
                                    <input type="radio" id="activeNo" name="Status" value="0" <% if (table.getStatus() == 0) { %> checked <% }%> >
            ...
            <script>
                        $(document).ready(function () {
                            $('#updateTableImg').change(function () {
                                var file = this.files[0];
                                var reader = new FileReader();

                                reader.onload = function (e) {
                                    $('#couponImagePreview').attr('src', e.target.result);
                                }
            ...
            <script>
                function doDelete(tableID) {
                    if (confirm("Are you sure you want to delete table with ID = " + tableID + "?")) {
