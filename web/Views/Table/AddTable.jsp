...
<html lang="en">
    ...
    <body>
        <div id="body">
            ...
            <div id="content">
                <form action="${pageContext.request.contextPath}/AddT" method="post" enctype="multipart/form-data">
                    ...
                    <div id="bg">
                        ...
                        <div class="form-group" id="tblID">
                            ...
                            <input type="text" name="tableID" id="tableID" value="${newTableID}" readonly/>
                        </div>
                        <div class="form-group">
                            <label for="floorSelect">Floor:</label>
                            <select name="floorid" id="floorSelect" required="">
                                <option value="Fl0001">Floor 1</option>
                                <option value="Fl0002">Floor 2</option>
                                <option value="Fl0003">Floor 3</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="tablenumber">Table Number:</label>
                            <input type="number" name="tablenumber" id="tablenumber" required=""/>
                        </div>
                        <div class="form-group">
                            <label for="seatingnumber">Seating Capacity:</label>
                            <input type="number" name="seatingnumber" id="seatingnumber" required=""/>
                        </div>

                        <div class="form-group image-upload">
                            <label for="img">Upload Image:</label>
                            <input id="inputimg" type="file" name="img" accept="image/*" required="" onchange="previewImage(event)"/>                           
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <div class="radio-container">
                                    <input type="radio" id="activeYes" name="Status" value="1" required>
                                    <label for="activeYes">Yes</label>
                                </div>
                                <div class="radio-container">
                                    <input type="radio" id="activeNo" name="Status" value="0" required>
