...
<html lang="en">
    <head>
        ...
        <script>
            function searchByAjax(param) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/searchD",
                    type: "get",
                    data: {
                        txtSearch: txtSear
                    },
        ...
        <style>
            ...
            #search{
                ...
                gap: 8px;
                border-radius: 12px;
                border: 1px solid var(--neutral-600, #DDD6C5);
    ...
    <body>
                ...
                <div id="header">
                    <form id="searchForm">
                        <div id="search" style="display: flex; width: 332px; padding: 12px 16px; align-items: center; gap: 8px; border-radius: 12px; border: 1px solid var(--neutral-600, #ddd6c5); box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="#DDD6C5">
                    ...
                    <form id="add" action="${pageContext.request.contextPath}/addD" method="get">
                        ...
                        <div id="allItems">
                            ...
                            <c:if test="${not empty result}">
                                <table>
                                    ...
                                    <tbody class="content">
                                        <c:forEach var="drink" items="${result}">
                                            <tr id="infoD">
                                                <td><img src="image/${drink.drinkImg}" alt="${drink.drinkName}" width="50"></td>
                                                <td>${drink.drinkID}</td>
                                                <td>${drink.drinkName}</td>
                                                <td>${drink.beverageID}</td>
                                                <td id="des">${drink.description}</td>
                                                <td>${drink.price}</td>
                                                <td>${drink.quantity}</td>
                                                <td>${drink.unit}</td>
                                                <td>
                                                    <!-- Button to Update Food -->
                                                    <form action="Views/Drink/UpdateDrink.jsp" method="get" style="display:inline;">
                                                    ...
                                                    <form action="${pageContext.request.contextPath}/deleteD" method="post" style="display:inline;" onsubmit="return confirmDelete(this, '${drink.drinkName}')" >
                                                        <input type="hidden" name="drinkID" value="${drink.drinkID}">
                                                        <button type="submit" class="btn btn-link">
        ...
        <script>
            function confirmDelete(form, food) {
