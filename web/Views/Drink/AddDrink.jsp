...
<html>
    ...
    <body>
        ...
        <div id="body">
            ...
            <div id="content">
                <form action="${pageContext.request.contextPath}/addD" method="post" enctype="multipart/form-data">
                    ...
                    <div id="bg">
                        ...
                        <div id="group">
                            ...
                            <input type="text" id="drinkID" name="drinkID" value="${newDrinkID}" readonly>
                        </div>
                        <br>
                        <div id="group">
