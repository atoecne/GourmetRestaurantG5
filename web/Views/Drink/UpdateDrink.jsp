...
<%@ page import="DAO.BeverageDAO" %>
<%@ page import="Model.BeverageModel" %>
...
<%
    ...
    List<BeverageModel> beverages = beverageDAO.getAllBeverage();
    ...
    <body>
        <div id="body">
            ...
            <div id="content">
                ...
                <form action="${pageContext.request.contextPath}/updateD" method="post" enctype="multipart/form-data">
                    ...
                    <div id="bg">
                        ...
                        <div id="group">
                            ...
                            <input type="text" id="drinkID" name="drinkID" value="<%= drink.getDrinkID()%>">
                        </div><br/>
                        <div id="group">
                            <label for="drinkName">Drink Name:</label>
                            <input type="text" id="drinkName" name="drinkName" value="<%= drink.getDrinkName()%>" required>
                        </div><br/>
                        <div id="group">
                            <label for="beverageID">Beverage Name:</label>
                            <select id="beverageID" name="beverageID" required>
                                <%
                                    for (BeverageModel beverage : beverages) {
                                %>
                                <option value="<%= beverage.getBeverageID()%>"><%= beverage.getBeverageName()%></option>
                                <%
                                    }
                                %>
                            </select>
                        ...
                        <div id="group">
                            ...
                            <textarea id="description" name="description" required><%= drink.getDescription()%></textarea>
                        </div><br/>
                        <div id="group">
                            <label for="price">Price:</label>
                            <input type="number" id="price" name="price" value="<%= drink.getPrice()%>" required>
                        </div><br/>
                        <div id="group">
                            <label for="quantity">Quantity:</label>
                            <input type="number" name="quantity" value="<%= drink.getQuantity()%>"/> 
                        </div><br/>
                        <div id="group">
                            <label for="unit">Unit :</label>
                            <input type="text" id="unit" name="unit" value="<%= drink.getUnit()%>" required> 
                        </div><br/>
                        <div id="group">
                            <label for="drinkImg">Drink Image:</label>
                            <input id="drinkImg" type="file" name="drinkImg" accept="image/*" required="" onchange="previewImage(event)"/>
                        </div>
