<%-- 
Document   : viewCashier
Created on : Jun 8, 2024, 3:29:25 PM
Author     : LENOVO
--%>
    ...
    <head>
        ...
        <script>
            function loadCart(tableID) {
                ...
                xhr.open('GET', 'viewOrder?tableID=' + tableID, true);
    ...
    <body onload="showFloor(1)">
        <div id="body">
            ...
            <div class="containerA">
                <div class="left">
                    <div class="tabs">
                        <div class="tab" id="tab1" onclick="showFloor(1)">Floor 1</div>
                        <div class="tab" id="tab2" onclick="showFloor(2)">Floor 2</div>
                        <div class="tab" id="tab3" onclick="showFloor(3)">Floor 3</div>
                    </div>
                    <div id="floor1" class="floor">
                        <div class="item-container">
                            <c:set var="floor1Tables" value="${requestScope.tablesByFloor['Fl0001']}"/>
                            <c:if test="${not empty floor1Tables}">
                                <c:forEach items="${floor1Tables}" var="t">
                                    <div class="item">
                                        <a href="javascript:void(0);" onclick="loadCart('${t.tableID}');" style="text-decoration: none">
                                            <h3>Table: ${t.tableNumber} - Floor ${t.floorID}</h3>
                                            <p>Capacity: ${t.seatingCapacity} people</p>
                                            <p>Status: ${t.status}</p>
                                        </a>
                                    </div>
                                </c:forEach>
                            </c:if>
                            <c:if test="${empty floor1Tables}">
                                <p>No tables found for Floor 1.</p>
                            </c:if>
                        </div>
                    </div>
                    <div id="floor2" class="floor">
                        <div class="item-container">
                            <c:set var="floor2Tables" value="${requestScope.tablesByFloor['Fl0002']}"/>
                            <c:if test="${not empty floor2Tables}">
                                <c:forEach items="${floor2Tables}" var="t">
                                    <div class="item">
                                        <a href="javascript:void(0);" onclick="loadCart('${t.tableID}');" style="text-decoration: none">
                                            <h3>Table: ${t.tableNumber} - Floor ${t.floorID}</h3>
                                            <p>Capacity: ${t.seatingCapacity} people</p>
                            ...
                            <c:if test="${empty floor2Tables}">
                                <p>No tables found for Floor 2.</p>
                            </c:if>
                        </div>
                    </div>
                    <div id="floor3" class="floor">
                        <div class="item-container">
                            <c:set var="floor3Tables" value="${requestScope.tablesByFloor['Fl0003']}"/>
                            <c:if test="${not empty floor3Tables}">
                                <c:forEach items="${floor3Tables}" var="t">
                                    <div class="item">
                                        <a href="javascript:void(0);" onclick="loadCart('${t.tableID}');" style="text-decoration: none">
                                            <h3>Table: ${t.tableNumber} - Floor ${t.floorID}</h3>
                                            <p>Capacity: ${t.seatingCapacity} people</p>
                            ...
                            <c:if test="${empty floor3Tables}">
                                <p>No tables found for Floor 3.</p>
                            </c:if>
                        </div>
                    </div>
                </div>
