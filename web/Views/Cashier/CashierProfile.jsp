...
<html>
    ...
    <body>
        <div id="body">
            ...
            <div id="bg">
                <c:set var="result" value="${sessionScope.datacashier}"/>
                <div class="profile-container">
                    ...
                    <div class="profile-button" id="bot">
                        <h2><a href="${pageContext.request.contextPath}/Views/Password/ChangePassword.jsp"> <input type="button" value="Change Password"/></a></h2> 
                        <h2><a href="${pageContext.request.contextPath}/updateCashierC"><input type="button" value="Edit Profile"></a></h2>
                    </div>
                </div>
            </div>
        </div>
