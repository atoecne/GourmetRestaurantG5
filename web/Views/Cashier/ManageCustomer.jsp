<%-- 
    ...
    Created on : Jun 21, 2024, 1:49:41 PM
    Author     : LENOVO
--%>
        ...
        <script>
            function showModal(phoneNumber) {
                ...
                confirmButton.onclick = function () {
                    document.getElementById('deleteForm-' + phoneNumber).submit();
                };
            ...
            <c:when test="${sessionScope.role == 'Manager'}">
                <div id="sidebar">
                    ...
                    <div id="gim">
                        ...
                        <div id="logout">
                            <button class="logout-buttonM" onclick="Logout()"><svg width="40px" height="40px" viewBox="0 0 24 24" fill="#282e52" xmlns="http://www.w3.org/2000/svg" stroke="white"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M16.125 12C16.125 11.5858 15.7892 11.25 15.375 11.25L4.40244 11.25L6.36309 9.56944C6.67759 9.29988 6.71401 8.8264 6.44444 8.51191C6.17488 8.19741 5.7014 8.16099 5.38691 8.43056L1.88691 11.4306C1.72067 11.573 1.625 11.7811 1.625 12C1.625 12.2189 1.72067 12.427 1.88691 12.5694L5.38691 15.5694C5.7014 15.839 6.17488 15.8026 6.44444 15.4881C6.71401 15.1736 6.67759 14.7001 6.36309 14.4306L4.40244 12.75L15.375 12.75C15.7892 12.75 16.125 12.4142 16.125 12Z" fill="#282e52"></path> <path d="M9.375 8C9.375 8.70219 9.375 9.05329 9.54351 9.3055C9.61648 9.41471 9.71025 9.50848 9.81946 9.58145C10.0717 9.74996 10.4228 9.74996 11.125 9.74996L15.375 9.74996C16.6176 9.74996 17.625 10.7573 17.625 12C17.625 13.2426 16.6176 14.25 15.375 14.25L11.125 14.25C10.4228 14.25 10.0716 14.25 9.8194 14.4185C9.71023 14.4915 9.6165 14.5852 9.54355 14.6944C9.375 14.9466 9.375 15.2977 9.375 16C9.375 18.8284 9.375 20.2426 10.2537 21.1213C11.1324 22 12.5464 22 15.3748 22L16.3748 22C19.2032 22 20.6174 22 21.4961 21.1213C22.3748 20.2426 22.3748 18.8284 22.3748 16L22.3748 8C22.3748 5.17158 22.3748 3.75736 21.4961 2.87868C20.6174 2 19.2032 2 16.3748 2L15.3748 2C12.5464 2 11.1324 2 10.2537 2.87868C9.375 3.75736 9.375 5.17157 9.375 8Z" fill="#282e52"></path> </g></svg></button>
                        </div>
                    </div>
                </div>
            </c:when>
    ...
    <div class="container">
        <c:choose>
            <c:when test="${param.action == 'create'}">
                <button id="cancel" onclick="window.location.href = '${pageContext.request.contextPath}/listCustomer?action=list';">
                    <svg width="32px" height="32px" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" 
                         fill="#282e52" stroke="#282e52"><g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                ...
                <form action="${pageContext.request.contextPath}/createCustomer" method="post">
                    <c:set var="result" value="${requestScope.newCustomer}"/>
                    <div id="crea">
                        <div id="gr"><label>
                                Phone number:
                            </label> Phone: <input type="text" id="phoneNumber" name="phoneNumber" 
                                                   pattern="^(0|\+84)\d{8,11}$"
                                                   title="Phone number must be 10 digits" 
                                                   required /><br></div>
                        <div id="gr"><label>
                                Name:
                            </label><input type="text" id="fullName" name="fullName" required /><br></div>   
            ...
            <c:when test="${param.action == 'list'}">
                ...
                <div id="hich">
                    ...
                    <button onclick="window.location.href = '${pageContext.request.contextPath}/Views/Cashier/ManageCustomer.jsp?action=create';">
                        ...
                        <tbody>
                            <c:forEach items="${customerList}" var="c">
                                <tr>
                                    ...
                                    <td>${c.point}</td>
                                    <td>
                                        <form action="${pageContext.request.contextPath}/Views/Cashier/ManageCustomer.jsp" method="get">
                                            <input type="hidden" name="action" value="update">
                                            <input type="hidden" name="phoneNumber" value="${c.phoneNumber}">                                           
                                            <button type="submit" id="st" class="btn btn-link">
                                        ...
                                        <form action="${pageContext.request.contextPath}/deleteCustomer" method="post" id="deleteForm-${c.phoneNumber}">
                                            <input type="hidden" name="phoneNumber" value="${c.phoneNumber}">
                                            <button id="st" type="button" value="Delete" onclick="showModal('${c.phoneNumber}');">
            ...
            <c:when test="${param.action == 'update'}">  
                ...
                <div id="inf">
                    ...
                    <form action="${pageContext.request.contextPath}/updateCustomer" method="post">            
                        <div id="upda">
                            <div id="gr"><label for="phoneNumer">Phone Number: ${param.phoneNumber}</label>
                                <input type="hidden" name="phoneNumber" value="${param.phoneNumber}"></div>
                            <div id="gr"><label for="fullName">Full Name:</label>
                            ...
                            <c:forEach items="${customerList}" var="c">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="${pageContext.request.contextPath}/deleteCustomer" method="post" id="deleteForm-${c.phoneNumber}">
                                            <input type="hidden" name="phoneNumber" value="${c.phoneNumber}">
                                            <input type="button" value="Delete" onclick="showModal('${c.phoneNumber}');">
                                        </form>
                                    </td>
                                </tr>
                            </c:forEach>
...
<script>
    ...
    function profile() {
        window.location.href = 'Views/Cashier/CashierProfile.jsp';
    }
</script>
<script>
