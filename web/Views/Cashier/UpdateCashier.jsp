...
<html>
    ...
    <body>
        <div id="body">
            ...
            <div id="content">
                <form action="${pageContext.request.contextPath}/updateCashierC" method="post">
                    ...
                    <div id="bg">
                        ...
                        <c:set var="c" value="${sessionScope.datacashier}"/>
                        <div id="group">
                            <label for="email">Email:</label>
                            <input type="text" id="email" name="email" readonly value="${c.email}"></div><br>
                        <div id="group">
                            <label for="fullname">Full Name:</label>
                            <input type="text" name="fullName" value="${c.fullName}" required/></div><br/>
                        <div id="group">
                            <label for="birthday">Birthday:</label>
                            <input type="date" name="birthday" value="${c.birthday}" required/></div><br/>
                        <div id="group">
                            <label for="phone">Phone Number:</label>
                            <input type="tel" name="phoneNumber" value="${c.phoneNumber}" required/></div><br/>
                        <div id="group">
                            <label for="address">Address:</label>
                            <input type="text" name="address" value="${c.address}" required/></div><br/>
