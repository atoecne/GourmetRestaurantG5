    ...
    <head>
        ...
        <script>
            function searchByAjax(param) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/searchF",
                    type: "get",
                    data: {
                        txtSearch: txtSear
                    },
        ...
        <div id="body">
            ...
            <div id="content">
                <div id="header">
                    ...
                    <form id="add" action="${pageContext.request.contextPath}/addF" method="get">
                                    ...
                                    <tbody class="content">
                                        <c:forEach var="food" items="${result}">
                                            <tr id="infoF">
                                                ...
                                                <td id="des">${food.description}</td>
                                                <td>${food.price}</td>
                                                <td>${food.quantity}</td>
                                                <td>${food.unit}</td>
                                                <td>

                                                    <form action="Views/Food/UpdateFood.jsp" method="get" style="display:inline;">
                                                    ...
                                                    <form action="${pageContext.request.contextPath}/deleteF" method="post" style="display:inline;" onsubmit="return confirmDelete(this, '${food.foodName}')" >
                                                        <input type="hidden" name="foodID" value="${food.foodID}">
                                                        <button type="submit" class="btn btn-link">
