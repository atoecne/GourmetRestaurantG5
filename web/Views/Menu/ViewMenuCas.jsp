    ...
    <head>
        ...
        <style>
            ...
            #contentD {
                ...
                background-color: rgba(0, 0, 0, 0.4);
                width: 100%;
                height: 100%; /* Updated height to auto */
                border-radius: 21px;
                box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5); /* Added shadow for better visibility */
            }
        ...
        <script>
        function showOrder() {
            window.location.href = '${pageContext.request.contextPath}/listOrder';
        }
        ...
        function profile() {
            window.location.href = '${pageContext.request.contextPath}/Views/Cashier/CashierProfile.jsp';
        }
        function Logout() {
        ...
        <div id="body">
            <div id="sidebar">
                ...
                <div id="gim">
                    ...
                    <button class="sidebar-button" onclick="manageCustomer()">
                    ...
                    <button class="sidebar-button" onclick="homeCashier()">
                    ...
                    <button class="sidebar-button" onclick="profile()">
                        ...
                        <c:if test="${not empty result}">
                            ...
                            <c:forEach var="food" items="${result}" varStatus="status">
                                <c:if test="${status.index % 3 == 0}">
                                    ...
                                    <div class="product-item ${food.quantity == 0 ? 'dimmed' : ''}">
                        ...
                        <c:if test="${not empty result}">
                            ...
                            <c:forEach var="drink" items="${result}" varStatus="status">
                                <c:if test="${status.index % 3 == 0}">
                                    ...
                                    <div class="product-item ${drink.quantity == 0 ? 'dimmed' : ''}" >
