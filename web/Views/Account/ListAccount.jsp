    ...
    <body>
                    ...
                    <div id="header">
                        <form id="searchForm" action="/search" method="get">
                            <div id="search" style="display: flex; width: 332px; padding: 12px 16px; align-items: center; gap: 8px; border-radius: 12px; border: 1px solid var(--neutral-600, #DDD6C5); box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);">
                                ...
                                <input id="searchQuery" type="text" name="staffSearch" value="${staffS}" oninput="searchByAjax(this)" style="border: none; outline: none; flex: 1;background: bottom;;">
                            </div>
                        </form>
                        <!--                        <form>
                                                    <input oninput="searchByAjax(this)" type="text" id="searchQuery" name="staffSearch" value="${staffS}"/>
                                                </form>-->
                        <form id="add" action="${pageContext.request.contextPath}/createAcc" method="get">
                                    ...
                                    <table border="1px" width="80%">
                                        <thead>
                                            <tr id="headerF">
                                                ...
                                                <th>Address</th>
                                                <th>Role
                                                    <select name="roleFilter" id="roleFilter" onchange="filterByRole(this.value)">
                                        ...
                                        <tbody class="content">
                                            <jsp:include page="/Views/Account/accountListFragment.jsp" /> 
                                        </tbody>
                                    </table>
                                </c:if>
                            </div>
        ...
        <script>
            function searchByAjax(param) {
                var staffSear = param.value;
                $.ajax({
                    url: "${pageContext.request.contextPath}/searchAccount",
                    type: "get",
                    data: {
                        staffSearch: staffSear
                    },
            ...
            function filterByRole(role) {
                $.ajax({
                    url: "${pageContext.request.contextPath}/filterByRole",
                    type: "get",
                    data: {
                        role: role
                    },
        ...
        <script>
            function confirmDelete(form, email) {
