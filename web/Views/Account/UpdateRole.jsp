    ...
    <body>
        <div id='body'>
            ...
            <div id="content">
                ...
                <c:set var="c" value="${requestScope.dataRole}"/>
                <c:set var="r" value="${requestScope.role}"/>

                <form action="${pageContext.request.contextPath}/updateRole" method="post" style="display:inline;">
                    ...
                    <div id="bg">
                        ...
                        <div id="group">
                            ...
                            <input type="text" name="email" readonly value="${c.email}">
                        </div><br/>
                        <div id="group">
                            <label for="fullname">Full Name:</label>
                            <input type="text" name="fullName" readonly value="${c.fullName}" required/>
                        </div><br/>
                        <div id="group">
                            <label for="birthday">Birthday:</label>
                            <input type="date" name="birthday" readonly value="${c.birthday}" required/>
                        </div><br/>
                        <div id="group">
                            <label for="phone">Phone Number:</label>
                            <input type="tel" name="phoneNumber" readonly value="${c.phoneNumber}" required/>
                        </div><br/>
                        <div id="group">
                            <label for="address">Address:</label>
                            <input type="text" name="address" readonly value="${c.address}" required/>
                        </div><br/>
                        <div id="group">
                            <label for="role">Role</label>
                            <div class="radio-group">
                                <div class="radio-container">
                                    <input type="radio" id="role" name="role" value="Cashier" required>
                                    <label for="activeNo">Cashier</label>
                                </div>
                                <div class="radio-container">
                                    <input type="radio" id="role" name="role" value="Serve" required>
