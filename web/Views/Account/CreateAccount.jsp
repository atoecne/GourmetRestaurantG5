...
<html lang="en">
    ...
    <body>
        <div id="body">
            ...
            <div id="content">
                <form action="${pageContext.request.contextPath}/createAcc" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                ...
                                <div class="radio-container">
                                    <input type="radio" id="type" name="type" value="Cashier" required>
                                    <label for="activeNo">Cashier</label>
                                </div>
                                <div class="radio-container">
                                    <input type="radio" id="type" name="type" value="Serve" required>
                                    <label for="activeNo">Serve</label>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            ...
            errorEmail.textContent = 'Invalid email format. Please re-enter.';
            return false;
            }
            //kiểm tra email trùng lặp
            var xhr = new XMLHttpRequest();
            xhr.open('POST', '${pageContext.request.contextPath}/checkEmail', false);
            xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            xhr.send('email=' + encodeURIComponent(emailValue));
            if (xhr.status === 200 && xhr.responseText === 'duplicate') {
            errorEmail.textContent = 'Email already exists. Please use another email.';
            return false;
            }
            ...
            errorPhone.textContent = 'Invalid phone number format. Please re-enter.';
            return false;
            }
            ...
            // Lắng nghe sự kiện input của email và phoneNumber
        ...
        <script>
            ...
            var errCreate = '<c:out value="${errCreate}"/>';
            if (errCreate.trim() !== '') {
            var errorMessage = document.getElementById('error-message');
            errorMessage.textContent = errCreate;
        ...
        <div id="error-message" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: red; color: white; padding: 20px; border-radius: 8px; z-index: 1000;"></div>
    </body>
</html>
