...
<html>
    ...
    <body>
        <div id="body">
            ...
            <div id="content">
                <form action="${pageContext.request.contextPath}/createCoupons" method="post" enctype="multipart/form-data">
                    ...
                    <div id="bg">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="couponID" name="couponID" required><br><br>
                        </div>
                        <div class="form-group">
                            <label for="couponDescription">Coupon Description:</label><br>
                            <textarea id="couponDescription" name="couponDescription" rows="4" cols="50"  maxlength="255" required></textarea><br><br>
                        </div>
                        <div class="form-group">
                            <label for="discountType">Discount Type:</label>
                            <select name="discountType" requied="">
                                <option value="%">%</option>
                        ...
                        <div class="form-group image-upload">
                            ...
                            <input id="inputimg" type="file" name="couponImg" id="img" accept="image/*" required="" onchange="previewImage(event)"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <div class="radio-container">
                                    <input type="radio" id="activeYes" name="active" value="1" required>
                                    <label for="activeYes">Yes</label>
                                </div>
                                <div class="radio-container">
                                    <input type="radio" id="activeNo" name="active" value="0" required>
        ...
        <script>
            ...
            function showOrderList() {
                // Add functionality to show order list
            }

            function showImportList() {
                // Add functionality to show import list
            }
