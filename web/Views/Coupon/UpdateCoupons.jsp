...
<%@ page import="Model.CouponsModel" %>
<%
    String couponID = request.getParameter("couponID");
    CouponDAO cpd = new CouponDAO();
    CouponsModel c = cpd.checkCouponID(couponID);
%>
...
<html lang="en">
    ...
    <body>
        <div id="body">
            ...
            <div id="content">
                <form action="${pageContext.request.contextPath}/updateC" method="post" enctype="multipart/form-data">                     
                    ...
                    <div id="bg">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="couponID" name="couponID_display" placeholder="<%= c.getCouponID()%>" readonly><br>
                        </div>

                        <div class="form-group">
                            <label for="couponDescription">Description:</label>
                            <textarea id="couponDescription" name="couponDescription" placeholder ="<%= c.getCouponDescription()%>" maxlength="250"></textarea><br>
                        </div>

                        <div class="form-group">
                            <label for="discountType">Discount Type:</label>
                            <select name="discountType" required>
                                <option value="%" <%= (c.getDiscountType().equals("%")) ? "selected" : ""%>>%</option>
                                <option value="VND" <%= (c.getDiscountType().equals("VND")) ? "selected" : ""%>>VND</option>
                            </select><br>
                        </div>

                        <div class="form-group">
                            <label for="discountValue">Discount Value:</label>
                            <input type="number" id="discountValue" name="discountValue" placeholder="<%= c.getDiscountValue()%>"></input><br>
                        </div>

                        <div class="form-group">
                            <label for="startDate">Start Date:</label>
                            <input type="text" id="startDate" name="startDate" placeholder="<%= c.getStartDate()%>"><br>
                        </div>

                        <div class="form-group">
                            <label for="endDate">End Date:</label>
                            <input type="text" id="endDate" name="endDate" placeholder="<%= c.getEndDate()%>" ><br>
                        </div>
                        <div class="form-group">
                            <label for="couponImg">Coupon Image:</label>
                            <input type="file" id="couponImg" name="couponImg">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <div class="radio-container">
                                    <input type="radio" id="activeYes" name="active" value="1" <% if (c.getActive() == 1) { %> checked <% } %> >
                                    <label for="activeYes">Yes</label><br>
                                </div>
                                <div class="radio-container">
                                    <input type="radio" id="activeNo" name="active" value="0" <% if (c.getActive() == 0) { %> checked <% }%> >
