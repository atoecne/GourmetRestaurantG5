...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=JejuHallasan:wght@400&display=swap" />
...
min-height: 90vh;
    ...
    <body>
                    ...
                    <div id="header">
                        <form id="searchForm">
                            <div id="search" style="display: flex; width: 332px; padding: 12px 16px; align-items: center; gap: 8px; border-radius: 12px; border: 1px solid var(--neutral-600, #ddd6c5); box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);">
                                ...
                                <input id="searchQuery" type="date" name="txtSearch" value="${txtS}" oninput="searchByAjax(this)" placeholder="Enter date..." style="border: none; outline: none; flex: 1;">
                            </div>
                        </form>

                        <form id="add" action="Views/Coupon/CreateCoupons.jsp" method="get">
                        ...
                        <div id="listF">
                            ...
                            <div id="allItems">
                                <table>
                                    ...
                                    <tbody class="content">
                                        <c:set var="result" value="${requestScope.listCoupons}"/>
                                        <c:if test="${not empty result}">
                                            <c:forEach var="c" items="${result}">
                                                <tr id="infoF">
                                                    ...
                                                    <td>${c.active}</td>
                                                    <td>
                                                        <form action="Views/Coupon/UpdateCoupons.jsp" method="get" style="display:inline;">
                                                        ...
                                                        <form id="deleteForm_${c.couponID}" action="${pageContext.request.contextPath}/deleteC" method="post"  style="display:inline;" onsubmit="return confirmDelete(this, '${c.couponID}')">
                                                            <input type="hidden" name="couponID" value="${c.couponID}">
                                                            <button type="submit" class="btn btn-link">
        ...
        <script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
        <script>
                                                            function confirmDelete(form, couponID) {
                                                                event.preventDefault();
                                                                Swal.fire({
                                                                    title: 'Are you sure you want to delete?',
                                                                    html: '<p>Coupon: ' + couponID + '</p>',
        ...
        <script>
            function searchByAjax(param) {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/SearchC",
                    type: "get",
                    data: {
                        txtSearch: txtSear
                    },
