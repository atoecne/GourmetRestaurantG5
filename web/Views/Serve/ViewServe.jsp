...
<html lang="en">
    <head>
        ...
        <script>
            function showFloorTables(floorId) {
                document.querySelectorAll('.table-grid').forEach(grid => grid.style.display = 'none');
        ...
        <style>
            ...
            .submit-btn {
                background-color: #e60000; /* Màu nền của nút */
    ...
    <body>
        <div id="body">
            ...
            <div class="container">
                ...
                <main>
                    <form id="tableForm" action="${pageContext.request.contextPath}/SelectTableController" method="post">
                        <input type="hidden" id="selectedTableID" name="tableID">
                        <div class="tabs">
                            <div class="tab" onclick="showFloorTables('Fl0001')" id="tab-Fl0001">
                                Floor 1
                            </div>
                            <div class="tab" onclick="showFloorTables('Fl0002')" id="tab-Fl0002">
                                Floor 2
                            </div>
                            <div class="tab" onclick="showFloorTables('Fl0003')" id="tab-Fl0003">
                                Floor 3
                            </div>
                        </div>
                        <div class="table" style="display: flex;">
                            <div class="table-grid" id="floor-Fl0001" style="display: flex; flex-wrap: wrap; width: 100%;">
                                <%
                                    TableDAO tableDAO = new TableDAO();
                                    List<TableModel> tableList = tableDAO.getTablesByFloor("Fl0001");
                                    int count = 0;
                                    for (TableModel table : tableList) {
                                        ...
                                        if (count % 5 == 0) {
                                            out.println("<div class='table-row' style='display: flex;'>");
                                        }
                                %>
                                <div class="table-item" data-table-id="<%= table.getTableID() %>">                                                                  
                                    <button class="select-btn" onclick="selectTable('<%= table.getTableID() %>')">
                                        <p>Table : <%= table.getTableNumber() %></p>
                                        <p>For: <%= table.getSeatingCapacity() %></p>
                                        <p>Status: <%= table.getStatus() == 1 ? "Available" : "Occupied" %></p>
                                    </button>                               
                                </div>
                                <%
                                        count++;
                            ...
                            <div class="table-grid" id="floor-Fl0002" style="display: flex; flex-wrap: wrap;">
                                <%
                                    tableList = tableDAO.getTablesByFloor("Fl0002");
                                    count = 0;
                                    for (TableModel table : tableList) {
                                        if (count % 5 == 0 && count != 0) {
                                            out.println("</div>");
                                        ...
                                        if (count % 5 == 0) {
                                            out.println("<div class='table-row' style='display: flex; width: 100%;'>");
                                        }
                                %>
                                <div class="table-item" data-table-id="<%= table.getTableID() %>">                                    
                                    <button class="select-btn" onclick="selectTable('<%= table.getTableID() %>')">
                            ...
                            <div class="table-grid" id="floor-Fl0003" style="display: flex; flex-wrap: wrap;">
                                <%
                                    tableList = tableDAO.getTablesByFloor("Fl0003");
                                    count = 0;
                                    for (TableModel table : tableList) {
                                        if (count % 5 == 0 && count != 0) {
                                            out.println("</div>");
                                ...
                                %>
                                <div class="table-item" data-table-id="<%= table.getTableID() %>">
                                    <img src="<%= table.getTableImg() %>" alt="Table Image" class="table-img">                                   
                                    <button class="select-btn" onclick="selectTable('<%= table.getTableID() %>')">
                                        <p>Table: <%= table.getTableNumber() %></p>
                                        <p>For: <%= table.getSeatingCapacity() %></p>
                                        <p>Status: <%= table.getStatus() == 1 ? "Available" : "Occupied" %></p>
        ...
        <script>
            ...
            showFloorTables('Fl0001');
            document.getElementById('tab-Fl0001').classList.add('active');
        </script>
    </body>
</html>
