<%-- 
    Document   : updateServe
    Created on : Jun 13, 2024, 3:18:20 PM
...
<html>
    <head>
        ...
        <title>Update Serve</title>
        <style>
            body {
                font-family: Arial, sans-serif;
                background-color:  #DDD6c5; /* Chọn màu nền phù hợp với thiết kế Figma */
                margin: 0;
                padding: 0;
            ...
            h1 {
                ...
                margin-bottom: 6%;
                color: #282e52;
                font-family: 'Arial Black', Gadget, sans-serif; /* Chọn font chữ đẹp */
                font-size: 3em; /* Kích thước chữ lớn */
                font-weight: bold; /* Chữ in đậm */
                text-align: center; /* Canh giữa */
                text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.2); /* Đổ bóng chữ để làm nổi bật */
            }
    ...
    <body>
        <div class="sidebar">
            ...
            <a class="a1" href="${pageContext.request.contextPath}/Views/Serve/ServeProfile.jsp">Back</a>
            <a class="a2" href="${pageContext.request.contextPath}/logout">Logout</a>
        </div>
        <div class="content">
            <div class="form-update">
                <h1>Update Serve</h1>
                <c:set var="c" value="${sessionScope.dataserve}"/>
                <form action="${pageContext.request.contextPath}/updateServeC" method="post">
                    <div class="profile-detail">
                        <label for="email">Email:</label>
                        <input style="margin-left: 100px;" type="text" id="email" name="email" readonly value="${c.email}"><br>
                    </div>

                    <div class="profile-detail">
                        <label for="fullname">Full Name:</label>
                        <input style="margin-left: 67px;" type="text" name="fullName" value="${c.fullName}" required/><br/>
                    </div>

                    <div class="profile-detail">
                        <label for="birthday">Birthday:</label>
                        <input style="margin-left: 78px;" type="date" name="birthday" value="${c.birthday}" required/><br/>
                    </div> 

                    <div class="profile-detail">
                        <label for="phone">Phone Number:</label>
                        <input style="margin-left: 29px;" type="tel" name="phoneNumber" value="${c.phoneNumber}" required/><br/>
                    </div>

                    <div class="profile-detail">
                        <label for="address">Address:</label>
                        <input style="margin-left: 79px;" type="text" name="address" value="${c.address}" required/><br/>
                    </div>
                    <div class="errol">
                        ${errorMessage}
                    </div>
