<%-- 
    Document   : serve
    Created on : 04-06-2024, 16:41:22
    Author     : ADMIN
--%>
...
<html>
    ...
    <body>
        ...
        <div class="content">
            <c:set var="result" value="${sessionScope.dataserve}"/>
            <div class="profile-container" style="margin-top: 7%;" >
                <h1> Your Profile</h1>
                <div class="profile-detail" >
                    <label>Email:</label>
                    <span style="margin-left: 153px;">${result.email}</span>
                </div>

                <div class="profile-detail">
                    <label>Full Name:</label>
                    <span style="margin-left:120px;">${result.fullName}</span>
                </div>
                <div class="profile-detail">
                    <label>Birthday:</label>
                    <span style="margin-left:131px;">${result.birthday}</span>
                </div>
                <div class="profile-detail">
                    <label>Phone Number:</label>
                    <span style="margin-left:90px">${result.phoneNumber}</span>
                </div>
                <div class="profile-detail">
                    <label>Address:</label>
                    <span style="margin-left:139px">${result.address}</span>
                </div>
                <div class="button">
                    <button id="buttonC"  onclick="showChangePassword()">Change Password</button>
                    <button id="buttonU"  onclick="showUpdateProfile()">Update Profile</button>
                </div>
            </div>
        </div>
        ...
        <script>
            function showChangePassword() {
                window.location.href = '${pageContext.request.contextPath}/Views/Password/ChangePassword.jsp';
            }

            function showUpdateProfile() {
                window.location.href = '${pageContext.request.contextPath}/Views/Serve/UpdateServe.jsp';
            }
            function showMenu() {
